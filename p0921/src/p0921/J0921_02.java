...
public class J0921_02 {
	...
	public static void main(String[] args) throws Exception {
		...
		while(true) {
			...
			//객체 생성해서 list에 담기(컬렉션 프레임웍)
     		StuScore s1 = new StuScore(stuNum,name,kor,eng,math); //한명씩
     		list.add(new StuScore(stuNum,name,kor,eng,math));
     		
//			StuScore s2 = new StuScore(stuNum,name,kor,eng,math);
//			StuScore s3 = new StuScore(stuNum,name,kor,eng,math);
